...
public class ProdutoController {
  ...
  @GetMapping("")
  public ResponseEntity<List<Produto>> pegarTodosOsProdutos() {
    return ResponseEntity.ok(bancoDeDados);
  }

  @PutMapping
  public ResponseEntity<Produto> alterarProduto(@PathVariable("codigo") int codigo, @RequestBody Produto novoProduto) {
